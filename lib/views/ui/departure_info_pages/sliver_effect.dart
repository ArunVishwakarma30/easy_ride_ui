// This page is not in use, It was create only for test purpose, I will delete it in future
...
class SliverEffect extends StatefulWidget {
  const SliverEffect({super.key});

  @override
  State<SliverEffect> createState() => _SearchPageState();
}

class _SearchPageState extends State<SliverEffect> {
        ...
        slivers: [
         ...
         SliverList(
           delegate: SliverChildBuilderDelegate((context, index) {
             return ReuseableText(text: "Test", style: appStyle(50, Colors.black, FontWeight.bold));
           },
           childCount: 50
           ),
